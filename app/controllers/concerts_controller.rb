class ConcertsController < ApplicationController
  ...
  def index
    @concerts = Concert.eager_load(:group) #disminuye las consultas en el index (N+1 query)
    @groups = Group.all
  end
  ...
  private
    ...
    def concert_params
      params.require(:concert).permit(:attendance, :duration, :concert_date, :group_id)
    end
end
